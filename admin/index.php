...
<head>
    ...
    <title>Admin Panel - Reza Auto Wash</title>
    <meta name="description" content="rezamobil - HTML5 Admin Template">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- Ganti URL logo dengan logo Reza Autowash -->
    <link rel="apple-touch-icon" href="rezamobil.png">
</head>
