...
-->
     ...
     <link rel="shortcut icon" type="image/x-icon" href="images/rezamobil.png">
     <!-- MAIN CSS -->
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-5">
                         <p>Kinclongkan kendaraan anda bersama Pro Auto Wash</p>
                    </div>

                    <div class="col-md-8 col-sm-7 text-align-right">
                         <span class="phone-icon"><i class="fa fa-phone"></i> 085876163709</span>
                         <span class="date-icon"><i class="fa fa-calendar-plus-o"></i> 08.30 - 17:00 (Setiap Hari)</span>
                    </div>
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand"><i class="fa fa-r-square"></i>Pro Auto Wash</a>
               </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                         <div class="about-info">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <p>Pro Autowash merupakan salah satu bidang usaha yang menawarkan jasa perawatan kendaraan berupa pencucian dan pembersihan kendaraan.</p>
                              </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb">
                              ...
                              <div class="contact-info">
                                   <p><i class="fa fa-phone"></i> 085876163709</p>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb">
                              <div class="opening-hours">
                                   ...
                                   <p>Senin - Minggu <span>08:30 - 17:00</span></p>
                              </div>
                         </div>
                    </div>
